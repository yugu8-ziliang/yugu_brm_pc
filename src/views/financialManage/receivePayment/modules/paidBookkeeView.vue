<template>
  <!-- 记账 -->
  <div
    class="paidBookkeeViewModel"
    :style="{ '--screenHeight': $store.getters.screenHeight - 250 + 'px' }"
  >
    <div class="flex_dom">
      <div class="paidBookkeeView-left">
        <el-scrollbar>
          <ul class="paidBookkeeView-left-ul">
            <li
              v-for="(item, index) in tableDataList"
              :key="index"
              class="paidBookkeeView-left-li flex_dom flex_item_mid flex_item_between"
              :style="{
      ...
      <div class="paidBookkeeView-right">
        <div class="paidBookkeeView-amount">
...
export default {
  ...
  methods: {
    getList(arg) {
      ...
      let param = {
        unpaidType: 7, // 未付类型    1-商品采购 2-筐子购入 3-退货退款 4-退筐退款 5-配送退货 6-配送退筐 7-记账
        pagesize: 0, // 当前第几页
        pagenum: 0, // 一页显示多少条
      };
...
.paidBookkeeViewModel {
  ...
  .paidBookkeeView-left {
    width: 300px;

    .paidBookkeeView-left-ul {
      margin-right: 7px;
      .paidBookkeeView-left-li {
  ...
  .paidBookkeeView-right {
    width: calc(100% - 300px);
    .paidBookkeeView-amount {
      margin-bottom: 10px;
