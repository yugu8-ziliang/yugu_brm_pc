<template>
  <!--退筐退款  -->
  <div class="refundView-model">
    <div class="refundView-search">
      <div>
        <el-input
          style="width: 270px"
...
export default {
  ...
  methods: {
    getList(arg) {
      ...
      let param = {
        orderType: 4, // 订单类型，1：销售款，2：退货退款，3：筐子售出，4：退筐退筐，5：转账
