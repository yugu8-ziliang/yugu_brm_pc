<template>
  <!-- 配送退筐 -->
  <div
    class="paidDeliveryViewModel"
    :style="{ '--screenHeight': $store.getters.screenHeight - 250 + 'px' }"
  >
    <div class="flex_dom">
      <div class="paidDeliveryView-left">
        <el-scrollbar>
          <ul class="paidDeliveryView-left-ul">
            <li
              v-for="(item, index) in tableDataList"
              :key="index"
              class="paidDeliveryView-left-li flex_dom flex_item_mid flex_item_between"
              :style="{
      ...
      <div class="paidDeliveryView-right">
        <div class="paidDeliveryView-amount">
...
export default {
  ...
  methods: {
    getList(arg) {
      ...
      let param = {
        unpaidType: 6, // 未付类型    1-商品采购 2-筐子购入 3-退货退款 4-退筐退款 5-配送退货 6-配送退筐 7-记账
        pagesize: 0, // 当前第几页
        pagenum: 0, // 一页显示多少条
      };
...
.paidDeliveryViewModel {
  ...
  .paidDeliveryView-left {
    width: 300px;

    .paidDeliveryView-left-ul {
      margin-right: 7px;
      .paidDeliveryView-left-li {
  ...
  .paidDeliveryView-right {
    width: calc(100% - 300px);
    .paidDeliveryView-amount {
      margin-bottom: 10px;
