<template>
  <!-- 订单未付 -->
  <div
    class="paidCommodityViewModel"
    :style="{ '--screenHeight': $store.getters.screenHeight - 250 + 'px' }"
  >
    <div class="flex_dom">
      <div class="paidCommodityView-left">
        <el-scrollbar>
          <ul class="paidCommodityView-left-ul">
            <li
              v-for="(item, index) in tableDataList"
              :key="index"
              class="paidCommodityView-left-li flex_dom flex_item_mid flex_item_between"
              :style="{
      ...
      <div class="paidCommodityView-right">
        <div class="paidCommodityView-amount">
...
export default {
  ...
  methods: {
    getList(arg) {
      ...
      let param = {
        unpaidType: 1, // 未付类型    1-商品采购 2-筐子购入 3-退货退款 4-退筐退款 5-配送退货 6-配送退筐 7-记账
        pagesize: 0, // 当前第几页
        pagenum: 0, // 一页显示多少条
      };
...
.paidCommodityViewModel {
  ...
  .paidCommodityView-left {
    width: 300px;

    .paidCommodityView-left-ul {
      margin-right: 7px;
      .paidCommodityView-left-li {
  ...
  .paidCommodityView-right {
    width: calc(100% - 300px);
    .paidCommodityView-amount {
      margin-bottom: 10px;
