<template>
  <!--退筐退款  -->
  <div class="recRefundView-model">
    <div class="recRefundView-search">
      <div>
        <el-input
          style="width: 300px"
    ...
    <div class="recRefundView-amount">
...
export default {
  ...
  methods: {
    getList(arg) {
      ...
      let param = {
        orderType: 4, // 订单类型，1 商品销售 2 筐子售出 3 退货退款 4 退筐退款 5 商品配送 6 记账 必传
...
.recRefundView-model {
  .recRefundView-search {
    padding-bottom: 15px;
    border-bottom: 1px solid #e9e9e9;
  }
  .recRefundView-amount {
    margin-top: 15px;
