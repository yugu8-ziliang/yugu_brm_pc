          ...
          <div v-for="(item, index) in dataS.payList" :key="index">
            ...
            <el-row style="margin-top: 5px">
              <el-col :span="6">
                <div>
                  <span
                    style="rgba(1, 6, 33, 0.75); font-size: 14px;font-weight: 700;"
                    >本次确认收款金额：</span
...
export default {
  ...
  methods: {
    ...
    getInfo() {
      ...
      let param = {
        orderType: 2, // 订单类型 int 1：筐子订单 2：商品订单 3：退货退款单 4：添加商品，添加入库 5:厂商自购筐子 6:退筐退款 7:筐子报废 9:配送退货 10:配送 11:配送退筐
