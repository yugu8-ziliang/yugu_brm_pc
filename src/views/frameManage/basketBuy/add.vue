  ...
  <Page v-loading="loading">
    <div v-if="editPage" style="padding:15px;">
      ...
      <el-form :model="form" :rules="rules" ref="form" inline label-position="left">
        ...
        <el-form-item label="联系电话" prop="toUserPhone" label-width="30%">
          <el-input v-model="form.toUserPhone"></el-input>
        </el-form-item>
        <el-form-item label="购入时间" prop="timestamp" label-width="30%" v-if="userType == 2">
          <el-date-picker
