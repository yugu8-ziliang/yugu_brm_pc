      ...
      <div style="margin-top: 10px">
        ...
        >
          <div>
            ...
            <div class="flex_dom" style="margin-top: 15px">
              <div style="white-space: nowrap; margin-top: 3px">残余价值：</div>
              <el-form
                :inline="true"
                ref="formModel3"
                class="marginform"
              ...
              >
                <el-form-item label=" " prop="orderTotalPrice">
                  <div class="search-form-border" style="width: 100%">
                    <el-input
                      v-model="formcolor3.orderTotalPrice"
                      placeholder="请输入"
                      size="mini"
                    ></el-input>
                  ...
                  <el-form-item label="" prop="fromUserName">
                    <div class="search-form-border" style="width: 100%">
                      <el-select
                        ref="factorySelect"
                        style="width: 200px"
                        v-model="formcolor3.fromUserName"
                        filterable
                        remote
                  ...
                  <el-form-item label="" prop="fromUserPhone">
                    <div class="search-form-border" style="width: 100%">
                      <el-select
                        ref="factorySelect"
                        style="width: 200px"
                        v-model="formcolor3.fromUserPhone"
                        filterable
                        remote
      ...
      <div style="font-size: 16px; color: rgba(1, 6, 33, 0.9)" class="flex_dom">
        <div>
          <span
            style="
              ...
              margin-right: 5px;
            "
            >收筐人姓名：{{ formcolor3.fromUserName || "&nbsp;" }}</span
          >
        ...
        <div style="margin-left: 40px">
          <span style="color: rgba(1, 6, 33, 0.9); font-size: 16px"
            >收筐人电话：{{ formcolor3.fromUserPhone || "&nbsp;" }}</span
          >
        </div>
      </div>
      <div style="margin-top: 20px">
...
export default {
  ...
  data() {
    var valiOverflowCount = (rule, value, callback) => {
      if (!value) {
        ...
        if (Number(Num) > Number(basketEmptyNumber)) {
          let String = "最多可报废" + basketEmptyNumber + "个";
    ...
    return {
      ...
      formcolor1: {},
      formcolor2: [],
      formcolor3: { fromUserName: "", fromUserPhone: "", orderTotalPrice: "" },
      formIndex: {
        name: "",
      },
      basketData: {},
  ...
  methods: {
    ...
    factoryNameRemoteMethodName(query) {
      this.formcolor3.fromUserName = query;
      //获取厂商名称
      let param1 = {
        cusName: query, // 客户名称
        phoneNumber: "", // 手机号搜索
    ...
    factoryNameRemoteMethodPhone(query) {
      this.formcolor3.fromUserPhone = query;
    ...
    clickChange(item, index) {
      this.formcolor3.fromUserName = item.cusname;
      this.formcolor3.fromUserPhone = item.phonenumber;
    },
    // 确认添加
    async confirmAdd() {
      if (this.isConfirm == 1) {
        ...
        if (data) {
          ...
          if (this.basketData.basketColor == "白色") {
            this.tableDataList.push({
              ...
              orderTotalPrice: this.formcolor3.orderTotalPrice,
              isCol: 1,
            });
          } else {
            this.formcolor2.forEach((res, i) => {
              this.tableDataList.push({
                ...
                orderTotalPrice: i == 0 ? this.formcolor3.orderTotalPrice : 0,
      ...
      this.$confirm("是否确认报失？", "提示", {
        ...
        .then(() => {
          let param = {
            ...
            fromUserName: this.formcolor3.fromUserName, //收筐人姓名 不需要传""
            fromUserPhone: this.formcolor3.fromUserPhone, //收筐人手机号 不需要传 ""
            scrapList: [],
          };
          ...
          if (this.basketData.basketColor == "白色") {
            param.scrapList.push({
              ...
              orderTotalPrice: this.formcolor3.orderTotalPrice, //残余价值 不需要传 0
              basketColor: [
                {
                  basketColor: this.basketData.basketColor,
    ...
    handleValidate() {
      ...
      let item2 = this.$refs.formModel3;
      list.push(
        new Promise((resolve) => {
          item2.validate((valida) => {
            validas.push(valida);
            resolve();
          });
        })
      );
      let item3 = this.$refs.formModel4;
      list.push(
        new Promise((resolve) => {
