  ...
  <div class="weighingDialogDialog">
    ...
    >
      <div class="marginform">
        ...
        >
          {{
            model.goodsMsg.catgoryfirstName +
            "-" +
            model.goodsMsg.categorysecondName +
            "-" +
            model.goodsMsg.name
          }}
          |
          {{ model.tableDataList.variety }}
        </div>
          ...
          <el-row>
            <el-col :span="9"
              ...
              ><span style="color: rgba(1, 6, 33, 0.9); font-size: 14px">{{
                model.tableDataList.regionname
              }}</span></el-col
            >
            <el-col :span="7"
              ><span style="color: rgba(1, 6, 33, 0.55); font-size: 14px"
              ...
              <el-col :span="8" style="margin-right: 10px">
                ...
                >
                  ...
                  <span
                    ...
                    "
                    >{{ model.tableDataList.subunit }}</span
                  >
                </el-form-item>
              </el-col>
                ...
                >
                  ...
                  <span
                    style="
                      ...
                      color: rgba(1, 6, 33, 0.75);
                    "
                    >{{ model.tableDataList.pieceunit }}</span
                  >
                </el-form-item>
              </el-col>

              <el-col :span="8" v-if="isshowtag||isshowtag1">
                <el-form-item
                  label=""
      ...
      <div class="creditLineBottom">
        <span
          ...
          "
        >
          {{ precisionSun2() }} {{ subComent }} {{ model.tableDataList.subunit
          }}<span v-if="model.goodsMsg.pieceUnit != ''"
            >({{ subComent1 }}{{ model.tableDataList.pieceunit }})</span
          ><span slot="suffix" v-if="isshowtag||isshowtag1"
            >|{{ subComent2
            }}<span style="color: rgba(223, 151, 26, 1); font-size: 13px"
              >筐</span
            ></span
          ></span
        >
...
export default {
  ...
  methods: {
    ...
    precisionSun() {
      if (
        this.model.tableDataList.subunit == "斤" ||
        this.model.tableDataList.subunit == "公斤" ||
        this.model.tableDataList.subunit == "g"
      ) {
        return 2;
      } else {
        return 0;
