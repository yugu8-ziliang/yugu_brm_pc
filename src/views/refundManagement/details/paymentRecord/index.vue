              ...
              <el-col :span="6" v-if="dataS.totalUnpaid">
                <div>
                  <span style="color: rgba(1, 6, 33, 0.55); font-size: 14px"
                    >剩余未付金额：</span
                  ><span style="color: rgba(1, 6, 33, 0.9); font-size: 14px"
                    >{{ dataS.totalUnpaid }}元</span 540 189
                  >
                </div>
              </el-col>
            </el-row>
        ...
        >
          ...
          <div v-for="(item, index) in dataS.payList" :key="index">
            ...
            <el-row style="margin-top: 5px">
              <el-col :span="6">
                <div>
                  <span style="color: rgba(1, 6, 33, 0.75); font-size: 14px;font-weight: 700;"
                    >本次确认付款金额：</span
            ...
            >
              ...
              <el-row style="margin-left: 10px"   v-if="payInfoLoc(item.payInfo)[0] != 0">
                <el-col :span="3">
                  <div>
                    <span style="color: rgba(1, 6, 33, 0.75); font-size: 14px"
                      >&nbsp; </span
                ...
                <el-col :span="6" v-if="item.comeInPrice">
                  <div>
                    ...
                    ><span
                      ...
                      "
                      @click="
                        handleView('creditFundsDialog', '经营往来款抵充',  {...item,basketInOutTypeView:formDatas.ordertype})
                      "
                      >查看明细</span
                    >
                  </div>
              ...
              <el-row style="margin-left: 10px" v-if="item.transferOtherPrice">
                <el-col :span="3">
                  <div>
                    <span style="color: rgba(1, 6, 33, 0.75); font-size: 14px"
                      >&nbsp;</span
            ...
            <div v-if="item.remark&&item.remark.length>0&&item.remark[0].remark">
            <el-row style="margin-top: 5px" v-if="item.remark.length > 0">
              ...
              <el-col :span="6">
                <div>
                  <span style="color: rgba(1, 6, 33, 0.55); font-size: 14px"
                    >发起时间：{{ item.remark[0].createtime | parseTime }}</span
                  >
                </div>
              </el-col>
            </el-row>
            <el-row v-if="item.remark.length > 0">
              ...
              <el-col :span="6">
                <div>
                  <span style="color: rgba(1, 6, 33, 0.55); font-size: 14px">{{
                    item.remark[0].printName
                  }}</span
                  ><span style="color: rgba(1, 6, 33, 0.9); font-size: 14px">{{
                    item.remark[0].remark
                  }}</span>
                </div>
              </el-col>
            </el-row>
  ...
  methods: {
    ...
    getInfo() {
      ...
      let param = {
        ...
        orderBindId: parseInt(rid), //单据id，int
        tip: 1, // 1.付款记录、2.收款记录
      };
