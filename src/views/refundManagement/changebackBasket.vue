  ...
  <PageNoScroll>
    <div v-if="editPage">
      ...
      >
        ...
        <!-- 售出单信息 -->
        <div class="block-title" style="margin-top: 1.25rem">售出单信息</div>
  ...
  data() {
    return {
      ...
      form: {
        ...
        remark: this.$route.query.NaNpxark, //备注   没有传""
      ...
      if (this.tableDataList.length > 0) {
        this.$refs.form.validate((valid) => {
          if (valid) {
            ...
            console.log(this.tableData, this.tableDataList);
          }
        });
      }
    },
    ...
    summitBack() {
      ...
      for (let i = 0; i < this.yltableData.length; i++) {
        param.basketDetails.push({
          ...
          userBasketName: this.yltableData[i].name1, //退筐筐子名称
