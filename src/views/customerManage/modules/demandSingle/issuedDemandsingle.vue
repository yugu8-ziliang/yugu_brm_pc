<template>
  <!-- 发出的需求单 -->
  <div
    class="issuedDemandsingleModel"
    :style="{ '--screenHeight': $store.getters.screenHeight - 390 + 'px' }"
  >
    <div class="adv-header-title">发出的需求单</div>
    <div class="flex_dom">
        ...
        <div class="paging">
          ...
          <!-- <div>
            <span
              ...
              "
              >已选
              <span style="color: rgba(11, 161, 152, 1)"
                >{{ sumCount }}</span
              >
              种商品</span
            >
