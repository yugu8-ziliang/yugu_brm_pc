<template>
  ...
  <el-scrollbar style="height: 100%">
    <div class="cardBox" style="background-color: rgba(0, 0, 0, 0.04);padding:24px;">
      ...
      <div class="lineH"></div>
      <div class="card-box">
        <span class="card-title">商品采购金额</span>
        <div class="card-price">
      ...
      <div class="lineH"></div>
      <div class="card-box">
        <span class="card-title">载货筐子采购金额</span>
        <div class="card-price">
          ...
          .then(res => {
            if (res.status == 200) {
              ...
              this.priceSum = {
                ...
                basketTotalPrice: res.data[0].basketTotalPrice // 头部载货筐子
              };
            }
          });
      },
