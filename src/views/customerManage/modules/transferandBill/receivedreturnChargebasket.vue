<template>
  <!-- 收到的归还记账筐子款 -->
  <el-scrollbar style="height: 100%" class="receivedreturnChargebasketModel">
    <div class="adv-header-title">收到的-归还记账筐子款</div>
    <div>
      <div class="flex_dom">
...
export default {
  name: "receivedreturnChargebasket",
  props: {
    toUserId: {
      type: String,
    },
...
.receivedreturnChargebasketModel {
  .adv-header-title {
    font-size: 20px;
