<template>
  <!-- 收到的预付款 -->
  <el-scrollbar style="height: 100%" class="receivedadvancePaymentModel">
    <div class="adv-header-title">收到的-预付款</div>
    <div>
      <div class="flex_dom">
