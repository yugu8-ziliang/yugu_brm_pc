<template>
  <!-- 收到的归还记账货款 -->
  <el-scrollbar style="height: 100%" class="receivedreturnAccountpaymentsModel">
    <div class="adv-header-title">收到的-归还记账货款</div>
    <div>
      <div class="flex_dom">
...
export default {
  name: "receivedreturnAccountpayments",
  props: {
    toUserId: {
      type: String,
    },
...
.receivedreturnAccountpaymentsModel {
  .adv-header-title {
    font-size: 20px;
