<template>
  <!-- 收到的归还预付款 -->
  <el-scrollbar style="height: 100%" class="receivedreturnadvancePaymentModel">
    <div class="adv-header-title">收到的-归还预付款</div>
    <div>
      <div class="flex_dom">
...
export default {
  name: "receivedreturnadvancePayment",
  props: {
    toUserId: {
      type: String,
    },
...
.receivedreturnadvancePaymentModel {
  .adv-header-title {
    font-size: 20px;
