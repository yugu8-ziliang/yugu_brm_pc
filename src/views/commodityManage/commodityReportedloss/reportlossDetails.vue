<template>
  <!-- 报损单详情 -->
  <PageNoScroll class="reportlossDetails">
    <el-scrollbar
      ref="scrollDiv"
      :style="{
    ...
    >
      ...
      >
        <el-descriptions title="订单信息">
          ...
          <el-descriptions-item label="报损单编号">{{
          ...
          <el-descriptions-item
            label="关联盘点单'"
            v-if="goodsDetail.relationModelNo"
          >
          ...
          <div style="margin-top: 18px">
            ...
            <div style="height: 100%">
              ...
              >
                ...
                <el-table-column label="报损前库存" prop="beforeCount">
                  <template slot-scope="scope">
                ...
                <el-table-column label="报损后库存" prop="afterCount">
                  <template slot-scope="scope">
                ...
                <el-table-column label="报损数量" prop="floatCount">
                  <template slot-scope="scope">
                ...
                <el-table-column label="入库成本单价" prop="costPrice">
                  <template slot-scope="scope">
                    {{ moneyFormatTwo(goodsDetailList1.costPrice) }}元/斤
                  </template>
                </el-table-column>
                <el-table-column label="腾空筐子" prop="floatBasketCount">
                  <template slot-scope="scope">
                    <el-button
                      type="text"
                      style="color: #1a7fd9"
                      v-if="goodsDetail.floatBasketCount"
                      @click="useBasket()"
                    >
                      {{ goodsDetail.floatBasketCount }}个
                    </el-button>
                    <span v-else>--</span>
                  </template>
                </el-table-column>
                <el-table-column label="报损金额" prop="totalPrice">
                  <template slot-scope="scope">
                    {{ moneyFormatTwo(goodsDetailList1.totalPrice) }}元
                  </template>
                </el-table-column>
              </el-table>
              <div class="table_count_styl">
                ...
                >
                <span style="margin-right: 32px">
                  报损总量:{{ goodsDetail.floatCount + goodsDetail.subUnit }}
                  {{ goodsDetail.subUnit2 != "" ? "(" : "" }}
                  {{
                    goodsDetail.subUnit3Weight == 0
                      ? ""
                ...
                <span style="margin-right: 32px"
                  >腾空筐子:{{ goodsDetail.floatBasketCount }}个</span
                >
                <span
                  >报损总额:{{
                    moneyFormatTwo(goodsDetail.productTotalPrice)
                  }}元</span
                >
              </div>
            </div>
      ...
      <div>
        ...
        >
          <div style="color: rgba(1, 6, 33, 0.55)">
            腾空筐子{{ goodsDetailList1.floatTypeCount }}种 &nbsp; 数量{{
